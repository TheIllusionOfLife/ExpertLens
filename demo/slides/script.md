...
## Slide 1: The Problem (0:00 to 0:30)
...
## Slide 2: Live Demo (0:30 to 2:00)
...
## Slide 3: Coach Builder (2:00 to 2:30)
...
## Slide 4: Preferences + Memory (2:30 to 3:00)
...
## Slide 6: Architecture (3:20 to 3:50)
...
- **Keep slides 3 to 6 tight.** 20-30 seconds each. The details are in the devpost writeup.
- **Total target: about 3:30 to 3:50** to leave buffer under the 4-minute limit.
